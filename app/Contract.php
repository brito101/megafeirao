...
class Contract extends Model {
    ...
    public function propertyObject() {
        return $this->hasOne(Automotive::class, 'id', 'automotive');
    }
    ...
    public function terms() {
        ...
        $terms[] = "<p style='text-align: center;'>CONTRATO DE {$parameters['purpouse']} DE VEÍCULO</p>";
