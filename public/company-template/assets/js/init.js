jQuery(function ($) {
    ...
    AUTOSTARS.TwitterWidget = function () {
        $(".twitter-widget").each(function () {
            ...
            twitterInstance.twittie({
                dateFormat: "%b. %d, %Y",
                template:
                    '<li><i class="fa fa-circle-o"></i> {{tweet}} <span class="date">{{date}}</span></li>',
                count: twitterTweets,
                hideReplies: true,
            });
        });
    ...
    AUTOSTARS.SuperFish = function () {
        ...
        $(".dd-menu > ul > li:has(ul)")
            .find("a:first")
            .append(" <i class='fa fa-angle-down'></i>");
        $(".dd-menu > ul > li > ul > li:has(ul)")
            .find("a:first")
            .append(" <i class='fa fa-angle-right'></i>");
        $(".dd-menu > ul > li > ul > li > ul > li:has(ul)")
            .find("a:first")
            .append(" <i class='fa fa-angle-right'></i>");
    };
                ...
                $(window).load(function () {
                    ...
                    $(window).on("hashchange", function (e) {
                        ...
                        source
                            ...
                            .addClass("active");
                        destination.isotope({ filter: hash });
                    });
                    var hashFilter =
    ...
    $(document).ready(function () {
        ...
        $(".listing-form-steps li:nth-child(1)").on("click", function () {
            $(".listing-form-progress .progress-bar")
                .attr("data-appear-progress-animation", "0%")
                .width("0%");
        });
        $(".listing-form-steps li:nth-child(2)").on("click", function () {
            $(".listing-form-progress .progress-bar")
                .attr("data-appear-progress-animation", "25%")
                .width("25%");
        });
        $(".listing-form-steps li:nth-child(3)").on("click", function () {
            $(".listing-form-progress .progress-bar")
                .attr("data-appear-progress-animation", "50%")
                .width("50%");
        });
        $(".listing-form-steps li:nth-child(4)").on("click", function () {
            $(".listing-form-progress .progress-bar")
                .attr("data-appear-progress-animation", "75%")
                .width("75%");
        });
        $(".listing-form-steps li:nth-child(5)").on("click", function () {
            $(".listing-form-progress .progress-bar")
                .attr("data-appear-progress-animation", "100%")
                .width("100%");
        });
        ...
        $(".search-advanced-trigger").on("click", function () {
            if ($(this).hasClass("advanced")) {
                ...
                $(this).html(
                    'Advanced Search <i class="fa fa-arrow-down"></i>'
                );
            }
            return false;
        });
    ...
    //             .find(".media-box")
    //             .append(
    //                 "<span class='zoom'><span class='icon'><i class='icon-plus'></i></span></span>"
    //             );
    //     });
    ...
    $("ul.checks li, .add-features-list li").prepend(
    ...
    $("ul.carets li, ul.inline li, .list-group-item").prepend(
