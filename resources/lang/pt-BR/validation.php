...
return [
    ...
    'attributes' => [
        ...
        'direction' => 'direção',
        'color' => 'cor',
        'electric_glass' => 'vidros elétricos dianteiros e traseiros',
        'eletric_lock' => 'trava elétrica',
        'sound' => 'som',
        'gas_kit' => 'kit gas',
        'multimedia_center' => 'central multimída',
        'only_owner' => 'único dono',
        'airbag' => 'airbag',
        'armored' => 'blindado',
        'electric_steering' => 'direção elétrica',
        'abs_brakes' => 'freiso ABS',
        'electric_rear_view' => 'retrovisores elétricos',
        'rain_sensor' => 'sensor de chuva',
        'parking_sensor' => 'sensor de estacionamento',
        'headlight_sensor' => 'sensor de farol',
        'sunroof' => 'teto solar',
        'traction' => 'tração 4 x 4',
        'electric_trio' => 'trio elétrico',
        'electric_front' => 'vidros elétricos dianteiros',
        'steering_wheel' => 'volante com regulagem de altura',
        'file' => 'arquivo',
        'slug' => 'link',
