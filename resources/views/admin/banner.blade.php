    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            ...
            <div class="nav">
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - Banner central horizontal</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - Banner inferior horizontal</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - 1º Banner da lateral direita</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - 2º Banner da lateral direita</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - 3º Banner da lateral direita</span>
                    ...
                    @if (isset($banner->cover7))
                        <div class="img-responsive-16by9 mb-1 text-center">
                            <img src="{{ asset('storage/' . $banner->cover7) }}" class="radius" alt=""
                                width="250">
                        </div>
                    @endif
                </div>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - 4º Banner da lateral direita</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME - 5º Banner da lateral direita</span>
                        <input type="file" name="cover9">
                        <input type="text" name="link9" class="city" placeholder="Link do banner"
                            value="{{ $banner ? old('link9') ?? $banner->link9 : old('link9') }}" />
                    </label>
                    @if (isset($banner->cover9))
                        <div class="img-responsive-16by9 mb-1 text-center">
                            <img src="{{ asset('storage/' . $banner->cover9) }}" class="radius" alt=""
                                width="250">
                        </div>
                    @endif
                </div>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA DE VEÍCULO - Banner superior</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA DE VEÍCULO - Banner inferior</span>
