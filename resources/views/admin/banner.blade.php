    ...
    <section class="dash_content_app">
        ...
        <div class="dash_content_app_box">
            ...
            <div class="nav">
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME</span>
                        <span class="legend">Banner central horizontal</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA HOME</span>
                        <span class="legend">Banner inferior horizontal</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA DE VEÍCULO</span>
                        <span class="legend">Banner superior</span>
                ...
                <div class="label_g2">
                    <label class="label">
                        <span class="legend">PÁGINA DE VEÍCULO</span>
                        <span class="legend">Banner inferior</span>
