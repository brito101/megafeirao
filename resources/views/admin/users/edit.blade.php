...
<section class="dash_content_app">
    ...
    <div class="dash_content_app_box">
        <div class="nav">
            ...
            <form class="app_form" action="{{ route('admin.users.update', ['user' => $user]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="nav_tabs_content">
                                    ...
                                    <div class="realty_list">
                                        ...
                                        <div class="realty_list_item mb-2">
                                            ...
                                            <div class="realty_list_item_content">
                                                ...
                                                <div class="realty_list_item_card" style="height: 80px;">
                                                    <div class="realty_list_item_card_image">
                                                        <span class="icon-bar-chart"></span>
                                                    </div>
                                                    <div class="realty_list_item_card_content">
                                                        <div class="text-center" style="flex-basis: 100%;">Visualizações:{{ $automotive->views }}</div>
                                                        @if($automotive->sale == true && !empty($automotive->sale_price))
                    ...
                    <div id="management" class="d-none">
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="admin"  {{ (old('admin') == 'on' || old('admin') == true ? 'checked' : ($user->admin == true ? 'checked' : '')) }}><span>Ativado</span>
                            </label>
                        </div>

                        <label class="label">
                            <span class="legend">Limite de Anúncios:</span>
                            <input type="tel" name="ads_limit"
                                   placeholder="Quantidade liberada" value="{{ old('ads_limit') ?? $user->ads_limit }}"/>
                        </label>
