...
<div class="main_contact py-5 bg-light text-center">
    <div class="container">
        ...
        <p class="mb-0">Quer conversar com um corretor exclusivo e ter o atendimento diferenciado para <b>anunciar</b> ou 
            <b>encontrar</b> o seu veículo  dos sonhos?</p>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p class="pt-2"><a href="mailto:contato@rodrigobrito.dev.br" class="text-front">ufrrj99@gmail.com</a></p>
            </div>

            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis nos números abaixo no horário comercial.</p>
                <p class="pt-2 text-front">+55 (21) 99359-4700</p>
            </div>
            ...
            <div class="col-12 col-md-4">
                ...
                <p>
                    <a href="{{ env("CLIENT_DATA_LINK_FACEBOOK") }}" target="_blank" class="btn btn-front icon-facebook icon-notext"></a>
                    <a href="{{ env("CLIENT_DATA_LINK_TWITTER") }}" target="_blank" class="btn btn-front icon-twitter icon-notext"></a>
                    <a href="{{ env("CLIENT_DATA_LINK_INSTAGRAM") }}" target="_blank" class="btn btn-front icon-instagram icon-notext"></a>
                </p>
            </div>
        </div>
    </div>
