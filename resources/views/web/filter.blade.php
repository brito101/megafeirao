    ...
    <div class="main_filter page_filter pb-2">
        <div class="container">
            <section class="row">
                ...
                <div class="col-12 col-lg-10 d-flex flex-wrap justify-content-between">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <select class="selectpicker" name="filter_brand" id="brand" title="Marca"
                                        data-index="2" data-action="{{ route('component.main-filter.brand') }}">
                                ...
                                <div class="form-group col-6 d-none">
                                    <select class="selectpicker" name="filter_base" id="base" title="Mínimo"
                                        data-index="4" data-action="{{ route('component.main-filter.priceBase') }}">
                                        <option disabled>Selecione o filtro anterior</option>
                                    </select>
                                </div>
                                <div class="form-group col-6 d-none">
                                    <select class="selectpicker" name="filter_limit" id="limit" title="Máximo"
                                        data-index="5" data-action="{{ route('component.main-filter.priceLimit') }}">
                                        <option disabled>Selecione o filtro anterior</option>
                                    </select>
                                </div>
                ...
                <div class="col-12 d-flex justify-content-center">
                    <iframe data-aa='2008281' src='//ad.a-ads.com/2008281?size=728x90'
