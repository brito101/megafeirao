...
/** Página de filtro */
Route::match(['post', 'get'], '/filtro', 'Web\\WebController@home')->name('web.filter');
...
Route::get('/filtro-cidade/{city}', 'Web\\WebController@filterCity')->name('web.filterCity');
Route::get('/filtro-ordenacao/{type}/{order}', 'Web\\WebController@filterOrder')->name('web.filterOrder');
...
Route::post('main-filter/state', 'Web\\FilterController@state')->name('component.main-filter.state');
